    ...
    <div className="min-h-screen bg-[#1A202C] text-[#F7FAFC] flex items-center justify-center">
      <div className="max-w-md w-full mx-4">
        <div className="bg-[#2D3748] p-8 rounded-lg">
          ...
          {/* <button className="w-full bg-[#4299E1] text-[#F7FAFC] px-6 py-3 rounded-lg font-medium hover:bg-[#3182CE] transition-colors flex items-center justify-center gap-2" href="/api/auth/signin">
